  ...
  return (
    <div>
      ...
      <div className="contenedor-cuentas">
        ...
        {/* Rellenar con cuadros vacíos si no hay suficientes cuentas para completar los 6 */}
        {[...Array(Math.max(0, cuentasPorPagina - cuentasPaginaActual.length))].map((_, index) => (
          <div className="cuenta-empty" key={index}></div>
        ))}
      </div>
